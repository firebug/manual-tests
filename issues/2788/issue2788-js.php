...
var _300=HAR.$("content");
if(_300){
return _300.getAttribute("version");
}
};
this.modules=[];
this.registerModule=function(_301){
this.modules.push(_301);
};
this.log=function(){
};
this.error=function(){
...
var _308="har"+this.now();
this.eventFix=function(_309){
if(_309[_308]==true){
return _309;
}
var _30a=_309;
_309={originalEvent:_30a};
var _30b="altKey attrChange attrName bubbles button cancelable charCode clientX clientY ctrlKey currentTarget data detail eventPhase fromElement handler keyCode metaKey newValue originalTarget pageX pageY prevValue relatedNode relatedTarget screenX screenY shiftKey srcElement target timeStamp toElement type view wheelDelta which".split(" ");
for(var i=_30b.length;i;i--){
_309[_30b[i]]=_30a[_30b[i]];
}
_309[_308]=true;
_309.preventDefault=function(){
if(_30a.preventDefault){
_30a.preventDefault();
}
_30a.returnValue=false;
};
_309.stopPropagation=function(){
if(_30a.stopPropagation){
_30a.stopPropagation();
}
_30a.cancelBubble=true;
};
_309.timeStamp=_309.timeStamp||this.now();
if(!_309.target){
_309.target=_309.srcElement||document;
}
if(_309.target.nodeType==3){
_309.target=_309.target.parentNode;
}
if(!_309.relatedTarget&&_309.fromElement){
_309.relatedTarget=_309.fromElement==_309.target?_309.toElement:_309.fromElement;
}
if(_309.pageX==null&&_309.clientX!=null){
var doc=document.documentElement,body=document.body;
_309.pageX=_309.clientX+(doc&&doc.scrollLeft||body&&body.scrollLeft||0)-(doc.clientLeft||0);
_309.pageY=_309.clientY+(doc&&doc.scrollTop||body&&body.scrollTop||0)-(doc.clientTop||0);
}
if(!_309.which&&((_309.charCode||_309.charCode===0)?_309.charCode:_309.keyCode)){
_309.which=_309.charCode||_309.keyCode;
}
if(!_309.metaKey&&_309.ctrlKey){
_309.metaKey=_309.ctrlKey;
}
if(!_309.which&&_309.button){
_309.which=(_309.button&1?1:(_309.button&2?3:(_309.button&4?2:0)));
}
return _309;
};
...
var _65=url.indexOf(":",3);
if(_65!=4){
return false;
}
var _66=url.indexOf(",",_65+1);
if(_66<_65){
return false;
}
var _67={encodedContent:url.substr(_66+1)};
var _68=url.substr(_65+1,_66);
var _69=_68.split(";");
...
if(_67.hasOwnProperty("fileName")){
var _6c=decodeURIComponent(_67["fileName"]);
var _6d=this.splitURLTrue(_6c);
if(_67.hasOwnProperty("baseLineNumber")){
_67["path"]=_6d.path;
_67["line"]=_67["baseLineNumber"];
var _6e=decodeURIComponent(_67["encodedContent"].substr(0,200)).replace(/\s*$/,"");
_67["name"]="eval->"+_6e;
}else{
_67["name"]=_6d.name;
_67["path"]=_6d.path;
...
if(!_67.hasOwnProperty("path")){
_67["path"]="data:";
}
if(!_67.hasOwnProperty("name")){
_67["name"]=decodeURIComponent(_67["encodedContent"].substr(0,200)).replace(/\s*$/,"");
}
}
return _67;
...
},eraseNode:function(_72){
while(_72.lastChild){
_72.removeChild(_72.lastChild);
}
},clearNode:function(_73){
_73.innerHTML="";
...
try{
var _75=obj.constructor();
for(var key in obj){
_75[key]=cloneJSON(obj[key]);
}
return _75;
}
catch(err){
...
if(_77.length>_78){
return this.escapeNewLines(_77.substr(0,_79)+"..."+_77.substr(_77.length-_79));
}else{
return this.escapeNewLines(_77);
}
},escapeNewLines:function(_7a){
return _7a.replace(/\r/g,"\\r").replace(/\n/g,"\\n");
},parseISO8601:function(_7b){
var _7c=/(\d\d\d\d)(-)?(\d\d)(-)?(\d\d)(T)?(\d\d)(:)?(\d\d)(:)?(\d\d)(\.\d+)?(Z|([+-])(\d\d)(:)?(\d\d))/;
var reg=new RegExp(_7c);
var m=_7b.toString().match(new RegExp(_7c));
if(!m){
return null;
}
var _7f=new Date();
_7f.setUTCDate(1);
_7f.setUTCFullYear(parseInt(m[1],10));
_7f.setUTCMonth(parseInt(m[3],10)-1);
_7f.setUTCDate(parseInt(m[5],10));
_7f.setUTCHours(parseInt(m[7],10));
_7f.setUTCMinutes(parseInt(m[9],10));
_7f.setUTCSeconds(parseInt(m[11],10));
if(m[12]){
_7f.setUTCMilliseconds(parseFloat(m[12])*1000);
}else{
_7f.setUTCMilliseconds(0);
}
if(m[13]!="Z"){
var _80=(m[15]*60)+parseInt(m[17],10);
_80*=((m[14]=="-")?-1:1);
_7f.setTime(_7f.getTime()-_80*60*1000);
}
return _7f.getTime();
},getURLParameter:function(_81){
var _82=window.location.search.substring(1);
var _83=_82.split("&");
...
return null;
},fireEvent:function(_86,_87){
if(document.createEvent){
var evt=document.createEvent("Events");
evt.initEvent(_87,true,false);
return !_86.dispatchEvent(evt);
}
},getCookie:function(_89){
var _8a=document.cookie.split(";");
for(var i=0;i<_8a.length;i++){
var _8c=_8a[i].split("=");
if(this.trim(_8c[0])==_89){
return _8c[1].length?unescape(this.trim(_8c[1])):null;
}
}
},setCookie:function(_8d,_8e,_8f,_90,_91,_92){
var _93=new Date();
_93.setTime(_93.getTime());
if(_8f){
_8f=_8f*1000*60*60*24;
}
var _94=new Date(_93.getTime()+_8f);
document.cookie=_8d+"="+escape(_8e)+(_8f?";expires="+_94.toGMTString():"")+(_90?";path="+_90:"")+(_91?";domain="+_91:"")+(_92?";secure":"");
},deleteCookie:function(_95,_96,_97){
if(this.getCookie(_95)){
document.cookie=_95+"="+(_96?";path="+_96:"")+(_97?";domain="+_97:"")+";expires=Thu, 01-Jan-1970 00:00:01 GMT";
}
}});
}
});
HAR.ns(function(){
with(Domplate){
HAR.Rep=domplate({className:"",inspectable:true,supportsObject:function(_10d,type){
return false;
},inspectObject:function(_10f,_110){
_110.chrome.select(_10f);
},browseObject:function(_111,_112){
},persistObject:function(_113,_114){
},getRealObject:function(_115,_116){
return _115;
},getTitle:function(_117){
if(dojo.isArray(_117)){
return "Array";
}
var _118=safeToString(_117);
var re=/\[object (.*?)\]/;
var m=re.exec(_118);
return m?m[1]:_118;
},getTooltip:function(_11b){
return null;
},getContextMenuItems:function(_11c,_11d,_11e){
return [];
},STR:function(name){
return $STR(name);
...
var _123=A({"class":"objectLink objectLink-$className",_repObject:"$object"});
var _124=SPAN({"class":"nodeAttr editGroup"},"&nbsp;",SPAN({"class":"nodeName editable"},"$attr.nodeName"),"=&quot;",SPAN({"class":"nodeValue editable"},"$attr.nodeValue"),"&quot;");
HAR.Rep.Nada=domplate(HAR.Rep,{tag:SPAN(""),className:"nada"});
HAR.Rep.Obj=domplate(HAR.Rep,{tag:_123(SPAN({"class":"objectTitle"},"$object|getTitle")),propIterator:function(_125){
if(!_125){
return [];
}
var _126=[];
...
var _12b=(t=="object")?Obj.getTitle(val):val+"";
len+=name.length+_12b.length+1;
if(len<50){
_126.push({name:name,value:_12b});
}else{
break;
}
}
...
return _126;
},className:"object",supportsObject:function(_12c,type){
return true;
}});
...
_1d5=_1d5?copyObject(_1d5,arguments[i]):arguments[i];
}
for(var name in _1d5){
var val=_1d5[name];
if(isTag(val)){
val.tag.subject=_1d5;
}
}
return _1d5;
};
domplate.context=function(_1d9,fn){
var _1db=domplate.lastContext;
domplate.topContext=_1d9;
fn.apply(_1d9);
domplate.topContext=_1db;
};
Domplate.TAG=function(){
var _1dc=new DomplateEmbed();
return _1dc.merge(arguments);
};
Domplate.FOR=function(){
var loop=new DomplateLoop();
return loop.merge(arguments);
};
DomplateTag.prototype={merge:function(args,_1df){
if(_1df){
this.tagName=_1df.tagName;
}
this.context=_1df?_1df.context:null;
this.subject=_1df?_1df.subject:null;
this.attrs=_1df?copyObject(_1df.attrs):{};
this.classes=_1df?copyObject(_1df.classes):{};
this.props=_1df?copyObject(_1df.props):null;
this.listeners=_1df?copyArray(_1df.listeners):null;
this.children=_1df?copyArray(_1df.children):[];
this.vars=_1df?copyArray(_1df.vars):[];
var _1e0=args.length?args[0]:null;
var _1e1=typeof (_1e0)=="object"&&!isTag(_1e0);
this.children=[];
if(domplate.topContext){
this.context=domplate.topContext;
}
if(args.length){
parseChildren(args,_1e1?1:0,this.vars,this.children);
}
if(_1e1){
this.parseAttrs(_1e0);
}
...
var _1e5=name.substr(2);
if(!this.listeners){
this.listeners=[];
}
this.listeners.push(_1e5,val);
}else{
if(name.indexOf("_")==0){
var _1e6=name.substr(1);
if(!this.props){
this.props={};
}
this.props[_1e6]=val;
...
if(name.indexOf("$")==0){
var _1e7=name.substr(1);
if(!this.classes){
this.classes={};
}
this.classes[_1e7]=val;
}else{
...
this.markupArgs=[];
var _1e8=[],topOuts=[],blocks=[],info={args:this.markupArgs,argIndex:0};
this.generateMarkup(_1e8,topOuts,blocks,info);
this.addCode(_1e8,topOuts,blocks);
var _1e9=["r=(function (__code__, __context__, __in__, __out__"];
...
if(this.context){
_1e9.push("with (__context__) {");
}
_1e9.push("with (__in__) {");
_1e9.push.apply(_1e9,blocks);
if(this.subject){
_1e9.push("}");
}
if(this.context){
...
_1e9.push("}})");
function __link__(tag,code,_1ed,args){
if(!tag||!tag.tag){
return;
}
tag.tag.compile();
var _1ef=[];
var _1f0=[code,tag.tag.context,args,_1ef];
_1f0.push.apply(_1f0,tag.tag.markupArgs);
tag.tag.renderMarkup.apply(tag.tag.subject,_1f0);
_1ed.push(tag);
_1ed.push(_1ef);
}
function __escape__(_1f1){
function replaceChars(ch){
switch(ch){
case "<":
return "&lt;";
...
return String(_1f1).replace(/[<>&"']/g,replaceChars);
}
function __loop__(iter,_1f4,fn){
var _1f6=[];
_1f4.push(_1f6);
...
var _1fd=this.children[i];
if(isTag(_1fd)){
_1fd.tag.getVarNames(args);
}else{
if(_1fd instanceof Parts){
for(var i=0;i<_1fd.parts.length;++i){
if(_1fd.parts[i] instanceof Variable){
var name=_1fd.parts[i].name;
var _1ff=name.split(".");
args.push(_1ff[0]);
}
}
...
},generateMarkup:function(_200,_201,_202,info){
_200.push(",\"<",this.tagName,"\"");
for(var name in this.attrs){
if(name!="class"){
var val=this.attrs[name];
_200.push(", \" ",name,"=\\\"\"");
addParts(val,",",_200,info,true);
_200.push(", \"\\\"\"");
}
}
if(this.listeners){
for(var i=0;i<this.listeners.length;i+=2){
readPartNames(this.listeners[i+1],_201);
}
}
if(this.props){
for(var name in this.props){
readPartNames(this.props[name],_201);
}
}
if(this.attrs.hasOwnProperty("class")||this.classes){
_200.push(", \" class=\\\"\"");
if(this.attrs.hasOwnProperty("class")){
addParts(this.attrs["class"],",",_200,info,true);
}
_200.push(", \" \"");
for(var name in this.classes){
_200.push(", (");
addParts(this.classes[name],"",_200,info);
_200.push(" ? \"",name,"\" + \" \" : \"\")");
}
_200.push(", \"\\\"\"");
}
_200.push(",\">\"");
this.generateChildMarkup(_200,_201,_202,info);
_200.push(",\"</",this.tagName,">\"");
},generateChildMarkup:function(_207,_208,_209,info){
for(var i=0;i<this.children.length;++i){
var _20c=this.children[i];
if(isTag(_20c)){
_20c.tag.generateMarkup(_207,_208,_209,info);
}else{
addParts(_20c,",",_207,info,true);
}
}
},addCode:function(_20d,_20e,_20f){
if(_20d.length){
_20f.push("__code__.push(\"\"",_20d.join(""),");");
}
if(_20e.length){
_20f.push("__out__.push(",_20e.join(","),");");
}
_20d.splice(0,_20d.length);
_20e.splice(0,_20e.length);
},addLocals:function(_210){
var _211=[];
this.getVarNames(_211);
var map={};
...
map[name]=1;
var _215=name.split(".");
_210.push("var ",_215[0]+" = "+"__in__."+_215[0]+";");
}
},compileDOM:function(){
var path=[];
var _217=[];
...
path.staticIndex=0;
path.renderIndex=0;
var _218=this.generateDOM(path,_217,this.domArgs);
var _219=["r=(function (root, context, o"];
...
_219.push("return ",_218,";");
_219.push("})");
function __bind__(_21b,fn){
return function(_21d){
return fn.apply(_21b,[_21d]);
};
}
...
tag.tag.compile();
var _221=[node,tag.tag.context,0];
_221.push.apply(_221,tag.tag.domArgs);
_221.push.apply(_221,args);
return tag.tag.renderDOM.apply(tag.tag.subject,_221);
}
var self=this;
...
iter[i][0]=i;
iter[i][1]=_225;
_225+=fn.apply(this,iter[i]);
}
return _225;
}
function __path__(_227,_228){
var root=_227;
for(var i=2;i<arguments.length;++i){
var _22b=arguments[i];
if(i==3){
_22b+=_228;
}
if(_22b==-1){
...
eval(js);
this.renderDOM=r;
},generateDOM:function(path,_22f,args){
if(this.listeners||this.props){
this.generateNodePath(path,_22f);
}
if(this.listeners){
for(var i=0;i<this.listeners.length;i+=2){
var val=this.listeners[i+1];
var arg=generateArg(val,path,args);
_22f.push("addEvent(node, \"",this.listeners[i],"\", __bind__(this, ",arg,"), false);");
}
}
if(this.props){
for(var name in this.props){
...
var arg=generateArg(val,path,args);
_22f.push("node.",name," = ",arg,";");
}
}
this.generateChildDOM(path,_22f,args);
return 1;
},generateNodePath:function(path,_236){
_236.push("var node = __path__(root, o");
for(var i=0;i<path.length;++i){
_236.push(",",path[i]);
}
_236.push(");");
},generateChildDOM:function(path,_239,args){
path.push(0);
for(var i=0;i<this.children.length;++i){
var _23c=this.children[i];
if(isTag(_23c)){
path[path.length-1]+="+"+_23c.tag.generateDOM(path,_239,args);
}else{
...
DomplateEmbed.prototype=copyObject(DomplateTag.prototype,{merge:function(args,_23e){
this.value=_23e?_23e.value:parseValue(args[0]);
this.attrs=_23e?_23e.attrs:{};
this.vars=_23e?copyArray(_23e.vars):[];
var _23f=args[1];
for(var name in _23f){
var val=parseValue(_23f[name]);
this.attrs[name]=val;
readPartNames(val,this.vars);
}
return creator(this,DomplateEmbed);
},getVarNames:function(_242){
if(this.value instanceof Parts){
_242.push(this.value.parts[0].name);
}
if(this.vars){
_242.push.apply(_242,this.vars);
}
},generateMarkup:function(_243,_244,_245,info){
this.addCode(_243,_244,_245);
_245.push("__link__(");
addParts(this.value,"",_245,info);
_245.push(", __code__, __out__, {");
var _247=null;
for(var name in this.attrs){
if(_247){
_245.push(",");
...
var val=this.attrs[name];
_245.push("\"",name,"\":");
addParts(val,"",_245,info);
}
_245.push("});");
},generateDOM:function(path,_24b,args){
var _24d="e"+path.embedIndex++;
this.generateNodePath(path,_24b);
var _24e="d"+path.renderIndex++;
var _24f="d"+path.renderIndex++;
_24b.push(_24d+" = __link__(node, ",_24e,", ",_24f,");");
return _24d;
}});
DomplateLoop.prototype=copyObject(DomplateTag.prototype,{merge:function(args,_251){
this.varName=_251?_251.varName:args[0];
this.iter=_251?_251.iter:parseValue(args[1]);
this.vars=[];
this.children=_251?copyArray(_251.children):[];
var _252=Math.min(args.length,2);
parseChildren(args,_252,this.vars,this.children);
return creator(this,DomplateLoop);
},getVarNames:function(_253){
if(this.iter instanceof Parts){
_253.push(this.iter.parts[0].name);
}
DomplateTag.prototype.getVarNames.apply(this,[_253]);
},generateMarkup:function(_254,_255,_256,info){
this.addCode(_254,_255,_256);
var _258;
if(this.iter instanceof Parts){
...
_258=part.format[i]+"("+_258+")";
}
}
}else{
_258=this.iter;
}
_256.push("__loop__.apply(this, [",_258,", __out__, function(",this.varName,", __out__) {");
this.generateChildMarkup(_254,_255,_256,info);
this.addCode(_254,_255,_256);
_256.push("}]);");
},generateDOM:function(path,_25c,args){
var _25e="d"+path.renderIndex++;
var _25f="i"+path.loopIndex;
var _260="l"+path.loopIndex++;
if(!path.length){
path.push(-1,0);
}
var _261=path.renderIndex;
path.renderIndex=0;
var _262=0;
var _263=[];
var _264=path[path.length-1];
for(var i=0;i<this.children.length;++i){
path[path.length-1]=_264+"+"+_260+"+"+_262;
var _266=this.children[i];
if(isTag(_266)){
_262+="+"+_266.tag.generateDOM(path,_263,args);
}else{
_262+="+1";
}
}
path[path.length-1]=_264+"+"+_260;
_25c.push(_260," = __loop__.apply(this, [",_25e,", function(",_25f,",",_260);
for(var i=0;i<path.renderIndex;++i){
_25c.push(",d"+i);
}
_25c.push(") {");
_25c.push(_263.join(""));
_25c.push("return ",_262,";");
_25c.push("}]);");
path.renderIndex=_261;
return _260;
}});
function Variable(name,_268){
this.name=name;
this.format=_268;
}
function Parts(_269){
...
var m;
while(m=re.exec(str)){
var pre=str.substr(_26c,(re.lastIndex-m[0].length)-_26c);
if(pre){
_26d.push(pre);
}
var expr=m[1].split("|");
_26d.push(new Variable(expr[0],expr.slice(1)));
_26c=re.lastIndex;
}
if(!_26c){
return str;
}
var post=str.substr(_26c);
if(post){
_26d.push(post);
}
return new Parts(_26d);
}
function parseValue(val){
return typeof (val)=="string"?parseParts(val):val;
}
function parseChildren(args,_274,vars,_276){
for(var i=_274;i<args.length;++i){
...
var part=val.parts[i];
if(part instanceof Variable){
var _283="d"+path.renderIndex++;
if(part.format){
for(var j=0;j<part.format.length;++j){
_283=part.format[j]+"("+_283+")";
}
}
vals.push(_283);
}else{
...
function addParts(val,_286,_287,info,_289){
var vals=[];
if(val instanceof Parts){
for(var i=0;i<val.parts.length;++i){
var part=val.parts[i];
...
if(part.format){
for(var j=0;j<part.format.length;++j){
_28d=part.format[j]+"("+_28d+")";
}
}
if(_289){
vals.push("__escape__("+_28d+")");
}else{
vals.push(_28d);
}
}else{
...
function addEvent(_29d,name,_29f){
if(document.all){
_29d.attachEvent("on"+name,_29f);
}else{
_29d.addEventListener(name,_29f,false);
}
}
function ArrayIterator(_2a0){
var _2a1=-1;
this.next=function(){
if(++_2a1>=_2a0.length){
throw StopIteration;
...
var _2a2={renderHTML:function(args,_2a4,self){
var code=[];
var _2a7=[code,this.tag.context,args,_2a4];
_2a7.push.apply(_2a7,this.tag.markupArgs);
this.tag.renderMarkup.apply(self?self:this.tag.subject,_2a7);
return code.join("");
},insertRows:function(args,_2a9,self){
this.tag.compile();
var _2ab=[];
var html=this.renderHTML(args,_2ab,self);
var doc=_2a9.ownerDocument;
var div=doc.createElement("div");
div.innerHTML="<table><tbody>"+html+"</tbody></table>";
var _2af=div.firstChild.firstChild;
var _2b0=_2a9.tagName=="TR"?_2a9.parentNode:_2a9;
var _2b1=_2a9.tagName=="TR"?_2a9.nextSibling:null;
var _2b2=_2af.firstChild,lastRow;
while(_2af.firstChild){
lastRow=_2af.firstChild;
if(_2b1){
_2b0.insertBefore(lastRow,_2b1);
}else{
_2b0.appendChild(lastRow);
}
}
var _2b3=0;
if(_2a9.tagName=="TR"){
var node=_2b2.parentNode.firstChild;
for(;node&&node!=_2b2;node=node.nextSibling){
++_2b3;
}
}
var _2b5=[_2b2,this.tag.context,_2b3];
_2b5.push.apply(_2b5,this.tag.domArgs);
_2b5.push.apply(_2b5,_2ab);
this.tag.renderDOM.apply(self?self:this.tag.subject,_2b5);
return [_2b2,lastRow];
},insertAfter:function(args,_2b7,self){
this.tag.compile();
var _2b9=[];
var html=this.renderHTML(args,_2b9,self);
var doc=_2b7.ownerDocument;
...
if(_2b7.nextSibling){
_2b7.parentNode.insertBefore(womb.firstChild,_2b7.nextSibling);
}else{
_2b7.parentNode.appendChild(womb.firstChild);
}
}
var _2bc=[root,this.tag.context,0];
_2bc.push.apply(_2bc,this.tag.domArgs);
_2bc.push.apply(_2bc,_2b9);
this.tag.renderDOM.apply(self?self:(this.tag.subject?this.tag.subject:null),_2bc);
return root;
},replace:function(args,_2be,self){
this.tag.compile();
var _2c0=[];
var html=this.renderHTML(args,_2c0,self);
var root;
if(_2be.nodeType==1){
_2be.innerHTML=html;
root=_2be.firstChild;
}else{
if(!_2be||_2be.nodeType!=9){
_2be=document;
}
if(!womb||womb.ownerDocument!=_2be){
womb=_2be.createElement("div");
}
womb.innerHTML=html;
root=womb.firstChild;
}
var _2c3=[root,this.tag.context,0];
_2c3.push.apply(_2c3,this.tag.domArgs);
_2c3.push.apply(_2c3,_2c0);
this.tag.renderDOM.apply(self?self:this.tag.subject,_2c3);
return root;
},append:function(args,_2c5,self){
this.tag.compile();
var _2c7=[];
var html=this.renderHTML(args,_2c7,self);
if(!womb||womb.ownerDocument!=_2c5.ownerDocument){
womb=_2c5.ownerDocument.createElement("div");
}
womb.innerHTML=html;
root=womb.firstChild;
while(womb.firstChild){
_2c5.appendChild(womb.firstChild);
}
var _2c9=[root,this.tag.context,0];
_2c9.push.apply(_2c9,this.tag.domArgs);
_2c9.push.apply(_2c9,_2c7);
this.tag.renderDOM.apply(self?self:this.tag.subject,_2c9);
return root;
}};
function defineTags(){
for(var i=0;i<arguments.length;++i){
var _2cb=arguments[i];
var fn=new Function("var newTag = new DomplateTag('"+_2cb+"'); return newTag.merge(arguments);");
var _2cd=_2cb.toUpperCase();
Domplate[_2cd]=fn;
}
}
...
},showInfoTip:function(_395,_396,_397,x,y,_39a,_39b){
var _39c=getOverflowParent(_397);
var _39d=x+(_39c?_39c.scrollLeft:0);
if(_396.showInfoTip(_395,_397,_39d,y,_39a,_39b)){
var _39e=_395.ownerDocument.documentElement;
var _39f=_39e.clientWidth;
var _3a0=_39e.clientHeight;
if(x+_395.offsetWidth+this.infoTipMargin>_39f-this.infoTipWindowPadding){
_395.style.left="auto";
_395.style.right=((_39f-x)+this.infoTipMargin)+"px";
}else{
_395.style.left=(x+this.infoTipMargin)+"px";
_395.style.right="auto";
}
if(y+_395.offsetHeight+this.infoTipMargin>_3a0){
_395.style.top=Math.max(0,_3a0-(_395.offsetHeight+this.infoTipMargin))+"px";
_395.style.bottom="auto";
}else{
_395.style.top=(y+this.infoTipMargin)+"px";
_395.style.bottom="auto";
}
_395.setAttribute("active","true");
}else{
this.hideInfoTip(_395);
}
},hideInfoTip:function(_3a1){
if(_3a1){
_3a1.removeAttribute("active");
}
},onMouseOut:function(_3a2){
if(!_3a2.relatedTarget){
this.hideInfoTip(this.infoTip);
}
},onMouseMove:function(_3a3){
var _3a4=HAR.Tab.Preview;
this.infoTip.setAttribute("multiline",false);
var x=_3a3.clientX,y=_3a3.clientY;
this.showInfoTip(this.infoTip,_3a4,_3a3.target,x,y,_3a3.rangeParent,_3a3.rangeOffset);
},populateTimingInfoTip:function(_3a6,_3a7){
this.tags.colorTag.replace({rgbValue:_3a7},_3a6);
return true;
}});
...
HAR.ns(function(){
with(HAR){
HAR.Model=extend({inputData:null,parseData:function(_1a1){
try{
var _1a2=HAR.now();
var _1a3=dojo.fromJson(_1a1);
HAR.log("har; parse data: "+HAR.Lib.formatTime(HAR.now()-_1a2));
return _1a3;
}
catch(err){
...
return null;
},setData:function(_1a4){
return this.inputData=_1a4;
},appendData:function(_1a5){
if(!_1a5){
return this.inputData;
}
if(this.inputData){
var _1a6=HAR.now();
for(var i=0;i<_1a5.log.pages.length;i++){
this.importPage(_1a5.log.pages[i],_1a5.log.entries);
}
HAR.log("har; Merge Data: "+HAR.Lib.formatTime(HAR.now()-_1a6));
}else{
this.inputData=_1a5;
}
return this.inputData;
...
var _1a9=this.inputData.log.pages;
...
var _1ab=this.inputData.log.entries;
for(var i=0;i<_1ab.length;i++){
var _1ac=_1ab[i];
if(_1ab[i].pageref==page.id){
_1ab.splice(i,1);
i--;
}
}
...
var _1ae=[];
var _1af=this.inputData?this.inputData.log.entries:null;
if(!_1af){
return _1ae;
}
for(var i=0;i<_1af.length;i++){
var _1b1=_1af[i];
if(!_1b1.pageref&&!page){
_1ae.push(_1b1);
}
if(page&&_1b1.pageref==page.id){
_1ae.push(_1b1);
}
}
return _1ae;
},getParentPage:function(file){
var _1b3=this.inputData.log.pages;
for(var i=0;i<_1b3.length;i++){
if(_1b3[i].id==file.pageref){
return _1b3[i];
}
}
return null;
},importPage:function(page,_1b6){
var _1b7=this.getUniquePageID(page.id);
var _1b8=page.id;
page.id=_1b7;
this.inputData.log.pages.push(page);
for(var i=0;i<_1b6.length;i++){
var _1ba=_1b6[i];
if(_1ba.pageref==_1b8){
_1ba.pageref=_1b7;
this.inputData.log.entries.push(_1ba);
}
}
},getUniquePageID:function(_1bb){
var _1bc=this.inputData.log.pages;
var _1bd={};
...
var _1c1=this.inputData.log.entries;
for(var i=0;i<_1c1.length;i++){
var _1c3=_1c1[i];
if(_1c3.response.content.text){
_1c3.response.content.__json__=contentToUnicode;
}
}
var _1c4=dojo.toJson(this.inputData,true);
var _1c5=_1c4.replace(/\\\\u/g,"\\u");
return _1c5;
}});
...
_1c6.text=Array.map(this.text,function(x){
var _1c9=x.charCodeAt(0);
if((_1c9>=32&&_1c9<127)||_1c9==10||_1c9==13){
return x.charAt(0);
}
var _1ca=_1c9.toString(16).toUpperCase();
while(_1ca.length<4){
_1ca="0"+_1ca;
}
return "\\u"+_1ca;
...
with(Domplate){
with(HAR.Lib){
HAR.Page.Pie=domplate({tag:TABLE({"class":"pagePieTable",cellpadding:0,cellspacing:0,_repObject:"$pie"},TBODY(TR(TD({"class":"pieBox",title:"$pie.title"}),TD(FOR("item","$pie.data",DIV({"class":"pieLabel",_repObject:"$item"},SPAN({"class":"box",style:"background-color: $item.color"},"&nbsp;"),SPAN({"class":"label"},"$item.label"))))))),render:function(pie,_99){
var _9a=this.tag.append({pie:pie},_99);
var _9b=getElementByClass(_9a,"pieBox");
...
return _9a;
},draw:function(_9d,pie){
if(!_9d||!_9d.getContext){
return;
}
var ctx=_9d.getContext("2d");
var _a0=Math.min(_9d.width,_9d.height)/2;
var _a1=[_9d.width/2,_9d.height/2];
ctx.clearRect(0,0,_9d.width,_9d.height);
var _a2=0;
var _a3=pie.data;
var _a4=0;
for(var i in _a3){
...
if(!_a4){
ctx.beginPath();
ctx.moveTo(_a1[0],_a1[1]);
ctx.arc(_a1[0],_a1[1],_a0,0,Math.PI*2,false);
ctx.closePath();
...
var _a6=_a3[i].value/_a4;
ctx.beginPath();
ctx.moveTo(_a1[0],_a1[1]);
ctx.arc(_a1[0],_a1[1],_a0,Math.PI*(-0.5+2*_a2),Math.PI*(-0.5+2*(_a2+_a6)),false);
ctx.lineTo(_a1[0],_a1[1]);
ctx.closePath();
ctx.fillStyle=_a3[i].color;
ctx.fill();
_a2+=_a6;
}
},showInfoTip:function(_a7,_a8,x,y){
var _ab=getAncestorByClass(_a8,"pagePieTable");
if(!_ab){
return false;
}
var _ac=getAncestorByClass(_a8,"pieLabel");
if(_ac){
HAR.Page.PieInfoTip.render(_ab.repObject,_ac.repObject,_a7);
return true;
}
}});
HAR.Page.PieInfoTip=domplate({tag:DIV({"class":"pieLabelInfoTip"},"$text"),getText:function(_ad){
return _ad.label+": "+formatTime(_ad.value);
},render:function(pie,_af,_b0){
var _b1=pie.getLabelTooltipText(_af);
this.tag.replace({text:_b1},_b0);
}});
}
}
});
...
var _134=new TimingPie();
var _135=new ContentPie();
var _136=new TrafficPie();
var _137=new CachePie();
var _138={"text/javascript":1,"text/jscript":1,"application/javascript":1,"application/x-javascript":1,"text/js":1};
var _139={"text/plain":1,"text/html":1};
var _13a={"text/css":1};
var _13b={"application/x-shockwave-flash":1};
var _13c={"text/x-json":1,"text/x-js":1,"application/json":1,"application/x-js":1};
var _13d={"application/xml":1,"application/xhtml+xml":1,"application/vnd.mozilla.xul+xml":1,"text/xml":1,"text/xul":1,"application/rdf+xml":1};
var _13e={"text/xsl":1,"text/sgml":1,"text/rtf":1,"text/x-setext":1,"text/richtext":1,"text/tab-separated-values":1,"text/rdf":1,"text/xif":1,"text/ecmascript":1,"text/vnd.curl":1,"text/vbscript":1,"view-source":1,"view-fragment":1,"application/x-httpd-php":1,"application/ecmascript":1,"application/http-index-format":1};
HAR.Page.Stats=domplate({rootNode:null,tag:DIV({"class":"pageStatsBody",style:"height: auto; display: none"}),render:function(_13f){
HAR.log("har; Page statistics, render: ");
this.rootNode=this.tag.replace({},_13f);
this.timingPie=HAR.Page.Pie.render(_134,this.rootNode);
this.contentPie=HAR.Page.Pie.render(_135,this.rootNode);
this.trafficPie=HAR.Page.Pie.render(_136,this.rootNode);
this.cachePie=HAR.Page.Pie.render(_137,this.rootNode);
...
this.cleanUp();
var _141=timingsType.timingsType.properties;
var _142=HAR.Model.getPageEntries(page);
for(var i=0;i<_142.length;i++){
var _144=_142[i];
var _145=0;
for(var _146 in _141){
_134.data[_145++].value+=_144.timings[_146];
}
var _147=_144.response.bodySize>0?_144.response.bodySize:0;
var _148=_144.response.content.mimeType;
if(_139[_148]){
_135.data[0].value+=_147;
_135.data[0].count++;
}else{
if(_138[_148]){
_135.data[1].value+=_147;
_135.data[1].count++;
}else{
if(_13a[_148]){
_135.data[2].value+=_147;
_135.data[2].count++;
}else{
if(_13a[_148]){
_135.data[5].value+=_147;
_135.data[5].count++;
}
}
}
}
_136.data[0].value+=_144.request.headersSize>0?_144.request.headersSize:0;
_136.data[1].value+=_144.request.bodySize>0?_144.request.bodySize:0;
_136.data[2].value+=_144.response.headersSize>0?_144.response.headersSize:0;
_136.data[3].value+=_147;
if(_144.response.status==206){
_137.data[1].value+=_147;
_137.data[1].count++;
}else{
if(_144.response.status==304){
_137.data[2].value+=_147;
_137.data[2].count++;
}else{
if(_147>0){
_137.data[0].value+=_147;
_137.data[0].count++;
}
}
}
}
HAR.Page.Pie.draw(getElementByClass(this.timingPie,"pieGraph"),_134);
HAR.Page.Pie.draw(getElementByClass(this.contentPie,"pieGraph"),_135);
HAR.Page.Pie.draw(getElementByClass(this.trafficPie,"pieGraph"),_136);
HAR.Page.Pie.draw(getElementByClass(this.cachePie,"pieGraph"),_137);
},cleanUp:function(){
_134.cleanUp();
_135.cleanUp();
_136.cleanUp();
_137.cleanUp();
},showInfoTip:function(_149,_14a,x,y){
return HAR.Page.Pie.showInfoTip(_149,_14a,x,y);
},show:function(_14d){
if(this.isOpened()){
return;
}
...
var _14f=HAR.Tab.Preview.stats.isOpened();
var _150=getElementByClass(document.documentElement,"harShowStats");
_150.innerHTML=_14f?$STR("button.Hide_Page_Stats"):$STR("button.Show_Page_Stats");
},onToggle:function(_151){
var e=HAR.eventFix(_151||window.event);
cancelEvent(_151);
var _153=e.target;
if(!hasClass(_153,"harButton")){
return;
}
var _154=HAR.Tab.Preview.stats;
var _155=_154.isOpened();
if(_155){
_154.hide(true);
}else{
_154.show(true);
}
setCookie("stats",!_155);
}});
}
}
});
...
var _318=Math.round((page.pageTimings.onLoad/this.maxElapsedTime)*100);
return Math.max(1,_318);
},onClick:function(_319){
var e=HAR.eventFix(_319||window.event);
var _31b=e.target;
if(!hasClass(_31b,"pageBar")){
return;
}
HAR.Rep.PageList.togglePage(_31b.repObject);
},onMouseMove:function(_31c){
var e=HAR.eventFix(_31c||window.event);
var _31e=e.target;
if(hasClass(_31e,"pageBar")){
this.updateDesc(_31e);
}
},updateDesc:function(_31f){
var page=_31f.repObject;
this.highlightedPage=page;
if(hasClass(this.rootNode,"opened")){
var _321=getElementByClass(this.rootNode,"pageDescContainer");
HAR.Page.Timeline.Desc.render(_321,_31f);
}
HAR.Page.Stats.update(page);
},updateDescByPage:function(page){
var _323=this.getPageBar(page);
if(_323){
this.updateDesc(_323);
}
},getPageBar:function(page){
if(!this.rootNode){
return;
}
var _325=getElementByClass(this.rootNode,"pageTimelineTable");
var col=_325.firstChild.firstChild.firstChild;
while(col){
...
},append:function(_327){
if(!this.rootNode){
return;
}
HAR.log("har; Page timeline, append inputData: ",_327);
this.recalcLayout();
var _328=getElementByClass(this.rootNode,"pageTimelineRow");
this.graphCols.insertCols({pages:_327.log.pages},_328);
this.updateSelection();
},recalcLayout:function(){
var _329=this.maxElapsedTime;
delete this.maxElapsedTime;
var _32a=HAR.Model.getPages();
for(var i=0;i<_32a.length;i++){
var _32c=_32a[i].pageTimings.onLoad;
if(!this.maxElapsedTime||this.maxElapsedTime<_32c){
this.maxElapsedTime=_32c;
}
}
if(_329!=this.maxElapsedTime){
...
var _32f=this.getPageBar(page);
if(!_32f){
return;
}
var col=_32f.parentNode;
...
var _331=getElementByClass(this.rootNode,"pageDescBox");
_331.style.visibility="hidden";
}
},render:function(_332){
this.rootNode=this.tag.replace({pages:HAR.Model.getPages()},_332);
this.recalcLayout();
},show:function(_333){
if(this.isOpened()){
return;
...
var _334=getElementByClass(this.rootNode,"pageBar");
if(_334){
HAR.Lib.fireEvent(_334,"mousemove");
}
}
},hide:function(_335){
if(!this.isOpened()){
...
_337+=$STR("label.Page_Load")+": "+formatTime(page.pageTimings.onLoad)+", ";
}
var _338=HAR.Model.getPageEntries(page);
_337+=HAR.Tab.Preview.formatRequestCount(_338.length);
return _337;
},getTime:function(page){
var _33a=parseISO8601(page.startedDateTime);
var date=new Date(_33a);
return date.toLocaleString();
},getTitle:function(page){
return page.title;
},getComment:function(page){
return page._comment?page._comment:"";
},render:function(_33e,_33f){
var page=_33f.repObject;
var _341=this.tag.replace({page:page},_33e);
var conn=getElementByClass(_341,"connector");
conn.style.marginLeft=_33f.parentNode.offsetLeft+"px";
}});
...
var _343=HAR.Tab.Preview.timeline.isOpened();
var _344=getElementByClass(document.documentElement,"harShowTimeline");
_344.innerHTML=_343?$STR("button.Hide_Page_Timeline"):$STR("button.Show_Page_Timeline");
},onToggle:function(_345){
var e=HAR.eventFix(_345||window.event);
cancelEvent(_345);
var _347=e.target;
if(!hasClass(_347,"harButton")){
return;
}
var _348=HAR.Tab.Preview.timeline;
var _349=_348.isOpened();
if(_349){
_348.hide(true);
}else{
_348.show(true);
}
setCookie("timeline",!_349);
}});
}
}
});
...
},onClickTab:function(_17c){
var e=HAR.eventFix(_17c||window.event);
this.selectTab(e.target);
},getParamValue:function(_17e){
return wrapText(_17e.value,true);
},selectTabByName:function(_17f,_180){
var tab=getChildByClass(_17f,"netInfoTabs","netInfo"+_180+"Tab");
if(tab){
this.selectTab(tab);
}
},selectTab:function(tab){
var _183=getAncestorByClass(tab,"netInfoBody");
var view=tab.getAttribute("view");
if(_183.selectedTab){
_183.selectedTab.removeAttribute("selected");
_183.selectedText.removeAttribute("selected");
}
var _185="netInfo"+view+"Text";
_183.selectedTab=tab;
_183.selectedText=getElementByClass(_183,_185);
_183.selectedTab.setAttribute("selected","true");
_183.selectedText.setAttribute("selected","true");
var file=getRepObject(_183);
if(file){
this.updateInfo(_183,file);
}
},updateInfo:function(_187,file){
var tab=_187.selectedTab;
if(hasClass(tab,"netInfoParamsTab")){
if(file.request.queryString&&!_187.urlParamsPresented){
_187.urlParamsPresented=true;
this.insertHeaderRows(_187,file.request.queryString,"Params");
}
}
if(hasClass(tab,"netInfoHeadersTab")){
if(file.response.headers&&!_187.responseHeadersPresented){
_187.responseHeadersPresented=true;
this.insertHeaderRows(_187,file.response.headers,"Headers","ResponseHeaders");
}
if(file.request.headers&&!_187.requestHeadersPresented){
_187.requestHeadersPresented=true;
this.insertHeaderRows(_187,file.request.headers,"Headers","RequestHeaders");
}
}
if(hasClass(tab,"netInfoPostTab")){
var _18a=getElementByClass(_187,"netInfoPostText");
if(!_187.postPresented){
_187.postPresented=true;
this.setPostText(file.request.postData,_187,_18a);
}
}
if(hasClass(tab,"netInfoPutTab")){
var _18b=getElementByClass(_187,"netInfoPutText");
if(!_187.putPresented){
_187.putPresented=true;
this.setPostText(file.request.postData,_187,_18b);
}
}
if(hasClass(tab,"netInfoCookiesTab")){
if(file.response.cookies&&!_187.responseCookiesPresented){
_187.responseCookiesPresented=true;
this.insertHeaderRows(_187,file.response.cookies,"Cookies","ResponseCookies");
}
if(file.request.cookies&&!_187.requestCookiesPresented){
_187.requestCookiesPresented=true;
this.insertHeaderRows(_187,file.request.cookies,"Cookies","RequestCookies");
}
}
if(hasClass(tab,"netInfoResponseTab")&&!_187.responsePresented){
var _18c=getElementByClass(_187,"netInfoResponseText");
if(file.category=="image"){
_187.responsePresented=true;
var _18d=_187.ownerDocument.createElement("img");
_18d.src=file.href;
clearNode(_18c);
_18c.appendChild(_18d,_18c);
}else{
this.setResponseText(file,_187,_18c);
}
}
if(hasClass(tab,"netInfoCacheTab")&&!_187.cachePresented){
_187.cachePresented=true;
var _18c=getElementByClass(_187,"netInfoCacheText");
if(file.cache&&file.cache.afterRequest){
var _18e=file.cache.afterRequest;
var _18f=[];
for(var prop in _18e){
_18f.push({name:prop,value:_18e[prop]});
}
this.insertHeaderRows(_187,_18f,"Cache");
}
}
if(hasClass(tab,"netInfoHtmlTab")&&!_187.htmlPresented){
_187.htmlPresented=true;
var text=file.response.content.text;
var _192=getElementByClass(_187,"netInfoHtmlPreview");
_192.contentWindow.document.body.innerHTML=text;
}
},setPostText:function(_193,_194,_195){
if(!_193){
return;
}
if(_193.mimeType=="application/x-www-form-urlencoded"){
this.insertHeaderRows(_194,_193.params,"Post");
}else{
insertWrappedText(_193.text,_195);
}
},setResponseText:function(file,_197,_198){
var text=file.response.content.text;
insertWrappedText(text,_198);
_197.responsePresented=true;
},insertHeaderRows:function(_19a,_19b,_19c,_19d){
var _19e=getElementByClass(_19a,"netInfo"+_19c+"Table");
var _19f=_19e.firstChild;
var _1a0=getChildByClass(_19f,"netInfo"+_19d+"Title");
if(_19b.length){
this.headerDataTag.insertRows({headers:_19b},_1a0?_1a0:_19f);
removeClass(_1a0,"collapsed");
}else{
setClass(_1a0,"collapsed");
}
}});
}
}
...
var _383=obj.bar.substr(obj.bar.lastIndexOf(".")+1);
return "net"+_383+"Bar";
},formatTime:function(time){
return HAR.Lib.formatTime(time);
},formatStartTime:function(time){
var _386=time>0;
var _387=HAR.Lib.formatTime(Math.abs(time));
if(!time){
return _387;
}
return (_386>0?"+":"-")+_387;
...
return $STR(obj.bar);
},render:function(row,_38a){
var file=row.repObject;
var _38c=parseISO8601(file.startedDateTime);
var _38d=HAR.Rep.EntryTimeInfoTip.tableTag.replace({},_38a);
var _38e={};
_38e.time=_38c-row.phase.startTime;
_38e.bar="request.Started";
this.startTimeTag.insertRows({startTime:_38e},_38d.firstChild);
this.separatorTag.insertRows({},_38d.firstChild);
var _38e=0;
var _38f=[];
_38f.push({bar:"request.phase.Resolving",elapsed:file.timings.dns,start:_38e});
_38f.push({bar:"request.phase.Connecting",elapsed:file.timings.connect,start:_38e+=file.timings.dns});
_38f.push({bar:"request.phase.Blocking",elapsed:file.timings.blocked,start:_38e+=file.timings.connect});
_38f.push({bar:"request.phase.Sending",elapsed:file.timings.send,start:_38e+=file.timings.blocked});
_38f.push({bar:"request.phase.Waiting",elapsed:file.timings.wait,start:_38e+=file.timings.send});
_38f.push({bar:"request.phase.Receiving",elapsed:file.timings.receive,start:_38e+=file.timings.wait,loaded:file.loaded,fromCache:file.fromCache});
this.timingsTag.insertRows({timings:_38f},_38d.firstChild);
var _390=[];
var page=HAR.Model.getParentPage(file);
var _392=page?parseISO8601(page.startedDateTime):null;
if(page&&page.pageTimings.onContentLoad>0){
_390.push({bar:"ContentLoad",start:_392+page.pageTimings.onContentLoad-_38c});
}
if(page&&page.pageTimings.onLoad>0){
_390.push({bar:"WindowLoad",start:_392+page.pageTimings.onLoad-_38c});
}
if(!_390.length){
return;
}
this.separatorTag.insertRows({},_38d.firstChild);
this.eventsTag.insertRows({events:_390},_38d.firstChild);
return true;
}});
HAR.Rep.EntrySizeInfoTip=domplate({tag:DIV({"class":"sizeInfoTip"},"$file|getSize"),getSize:function(file){
var _394=file.response.bodySize;
return $STRF("tooltip.size",[formatSize(_394),((file.size<0)?"?":formatNumber(_394))]);
}});
}
}
});
...
var _34c=Math.floor(file.response.status/100);
return _34c==4||_34c==5;
...
var _351=file.response.status>0?(file.response.status+" "):"";
return _351+file.response.statusText;
...
return true;
},formatSize:function(_355){
return formatSize(_355);
},getElapsedTime:function(file){
return formatTime(file.time);
},onClick:function(_357){
var e=HAR.eventFix(_357||window.event);
if(isLeftClick(_357)){
...
},setFilter:function(_35a){
this.filterCategory=_35a;
var _35b=this.panelNode;
for(var _35c in fileCategories){
if(_35a!="all"&&_35c!=_35a){
setClass(_35b,"hideCategory-"+_35c);
}else{
removeClass(_35b,"hideCategory-"+_35c);
}
}
...
var _35f=HAR.Rep.EntryBody;
var _360=this.netInfoTag.insertRows({},row)[0];
_360.repObject=file;
var _361=_35f.tag.replace({file:file},_360.firstChild);
_35f.selectTabByName(_361,"Headers");
}else{
var _360=row.nextSibling;
var _361=getElementByClass(_360,"netInfoBody");
row.parentNode.removeChild(_360);
}
}});
}
}
...
return "["+page.id+"]";
},onClick:function(_364){
var e=HAR.eventFix(_364||window.event);
if(isLeftClick(_364)){
...
var _36b=HAR.Model.removePage(page);
HAR.Tab.Preview.timeline.removePage(page);
HAR.Tab.Preview.stats.update(HAR.Tab.Preview.timeline.highlightedPage);
var _36c=getElementByClass(document.documentElement,"tabDOMBody");
if(_36c){
_36c.updated=false;
}
},onMouseMove:function(_36d){
var e=HAR.eventFix(_36d||window.event);
cancelEvent(_36d);
},toggleRow:function(row,_370){
var _371=hasClass(row,"opened");
if(_371&&_370){
return;
}
toggleClass(row,"opened");
if(hasClass(row,"opened")){
var _372=this.bodyTag.insertRows({},row)[0];
HAR.Tab.Preview.buildPageContent(_372.firstChild,row.repObject);
dojo.fx.wipeIn({node:_372}).play();
}else{
var _372=row.nextSibling;
dojo.fx.wipeOut({node:_372}).play();
row.parentNode.removeChild(_372);
}
},expandAll:function(_373){
var row=_373.firstChild.firstChild;
while(row){
...
},render:function(_379,_37a){
this.rootNode=this.tableTag.append({groups:_379},_37a);
return this.rootNode;
...
HAR.ns(function(){
with(Domplate){
HAR.Rep.Schema=domplate({errorTable:TABLE({"class":"errorTable",cellpadding:0,cellspacing:5},TBODY(FOR("error","$errors",TR({"class":"errorRow",_repObject:"$error"},TD({"class":"errorProperty"},SPAN("$error.property")),TD("&nbsp;"),TD({"class":"errorMessage"},SPAN("$error.message")))))),parseInputData:function(_30e,_30f,_310){
if(!_30e){
return;
}
var _311=HAR.Model.parseData(_30e);
if(!_311){
this.renderErrorList(_30f,HAR.Model.errors);
return null;
}
if(_310){
var _312=HAR.now();
...
var _313=dojox.json.ref.resolveJson(schema);
HAR.log("har; resolvedSchema %o, %o",_313,_313.logType);
var _314=dojox.json.schema.validate(_311,_313.logType);
if(!_314.valid){
HAR.log("har; Validation failed.",_314.errors);
this.renderErrorList(_30f,_314.errors);
return null;
}
HAR.log("har; validate data: "+HAR.Lib.formatTime(HAR.now()-_312));
}
return _311;
},renderErrorList:function(_315,_316){
this.errorTable.append({errors:_316},_315,this);
}});
}
});
HAR.ns(function(){
with(Domplate){
HAR.Rep.TabView=domplate(HAR.Rep,{listeners:[],tag:TABLE({"class":"tabView",cellpadding:0,cellspacing:0},TBODY(TR({"class":"tabViewRow"},TD({"class":"tabViewCol",valign:"top"},TAG("$tabList"))))),hideTab:function(_3a8){
return false;
},onClickTab:function(_3a9){
var e=HAR.eventFix(_3a9||window.event);
var tab=HAR.Lib.getAncestorByClass(e.target,"tab");
if(tab){
this.selectTab(tab);
}
},selectTabByName:function(_3ac,_3ad){
var tab=HAR.Lib.getElementByClass(_3ac,_3ad+"Tab");
if(tab){
this.selectTab(tab);
}
},selectTab:function(tab){
...
var view=tab.getAttribute("view");
var _3b1=HAR.Lib.getAncestorByClass(tab,"tabViewBody");
if(_3b1.selectedTab){
_3b1.selectedTab.removeAttribute("selected");
_3b1.selectedBody.removeAttribute("selected");
HAR.Lib.removeClass(_3b1.selectedTab,"selected");
HAR.Lib.removeClass(_3b1.selectedBody,"selected");
}
var _3b2=HAR.Lib.getElementByClass(_3b1,"tab"+view+"Body");
_3b1.selectedTab=tab;
_3b1.selectedBody=_3b2;
_3b1.selectedTab.setAttribute("selected","true");
_3b1.selectedBody.setAttribute("selected","true");
HAR.Lib.setClass(_3b1.selectedBody,"selected");
HAR.Lib.setClass(_3b1.selectedTab,"selected");
this.updateTabBody(_3b1,view,null);
},updateTabBody:function(_3b3,view,_3b5){
var tab=_3b3.selectedTab;
for(var i=0;i<this.listeners.length;i++){
var _3b8=this.listeners[i];
if(_3b8.onUpdateTabBody){
_3b8.onUpdateTabBody(_3b3,view,_3b5);
}
}
},appendUpdateListener:function(_3b9){
this.listeners.push(_3b9);
},removeUpdateListener:function(_3ba){
remove(this.listeners,_3ba);
},render:function(obj,_3bc){
return this.tag.replace(obj,_3bc,this);
}});
}
});
HAR.ns(function(){
...
var _3bd=HAR.$("pageList");
if(!_3bd){
return;
}
var _3be=HAR.Lib.getURLParameter("path");
HAR.Viewer.loadLocalArchive(_3be,function(_3bf){
var _3c0=HAR.Rep.Schema.parseInputData(_3bf,_3bd,false);
if(_3c0){
HAR.Model.appendData(_3c0);
clearNode(_3bd);
var _3c1=HAR.Tab.Preview.buildPageList(_3bd,_3c0);
if(HAR.Lib.getURLParameter("expand")){
HAR.Rep.PageList.expandAll(_3c1);
}
}
});
}});
...
with(Domplate){
with(HAR.Lib){
HAR.Tab.DomView=domplate({render:function(_156,_157){
HAR.log("har; Render DOM tab.");
var _158=this.tag.replace({object:_156},_157);
if(_158.firstChild.firstChild){
this.toggleRow(_158.firstChild.firstChild);
}
...
return _159.hasChildren?"hasChildren":"";
},memberIterator:function(_15a){
return this.getMembers(_15a);
},getRowTag:function(_15b){
return this.rowTag;
},onClick:function(_15c){
var e=HAR.eventFix(_15c||window.event);
if(!isLeftClick(_15c)){
return;
}
var row=getAncestorByClass(e.target,"memberRow");
var _15f=getAncestorByClass(e.target,"memberLabel");
if(_15f&&hasClass(row,"hasChildren")){
this.toggleRow(row);
}
},toggleRow:function(row){
var _161=parseInt(row.getAttribute("level"));
if(hasClass(row,"opened")){
removeClass(row,"opened");
var _162=row.parentNode;
for(var _163=row.nextSibling;_163;_163=row.nextSibling){
if(parseInt(_163.getAttribute("level"))<=_161){
break;
}
_162.removeChild(_163);
}
}else{
setClass(row,"opened");
var _164=row.repObject;
if(_164){
var _165=this.getMembers(_164.value,_161+1);
if(_165){
this.loop.insertRows({members:_165},row);
}
}
}
},getMembers:function(_166,_167){
if(!_167){
_167=0;
}
var _168=[];
...
_168.push(this.createMember("dom",p,_16a,_167));
}
}
return _168;
},createMember:function(type,name,_16d,_16e){
var rep=HAR.Rep.Obj;
var tag=rep.shortTag?rep.shortTag:rep.tag;
var _171=typeof (_16d);
var _172=this.hasProperties(_16d)&&(_171=="object");
return {name:name,value:_16d,type:type,rowClass:"memberRow-"+type,open:"",level:_16e,indent:_16e*16,hasChildren:_172,tag:tag};
...
with(Domplate){
with(HAR.Lib){
HAR.Tab.InputView=domplate({render:function(_3c2){
HAR.log("har; Render Input tab.");
var _3c3=HAR.$("InputTabTemplate");
_3c2.innerHTML=_3c3.innerHTML;
clearNode(_3c3);
},onAppendPreview:function(_3c4){
HAR.log("har; onAppendPreview");
if(!_3c4){
_3c4=HAR.$("sourceEditor").value;
}
var _3c5=HAR.$("validate").checked;
var _3c6=document.documentElement;
var _3c7=getElementByClass(_3c6,"tabPreviewBody");
var _3c8=getElementByClass(_3c7,"pageList");
var _3c9=HAR.Rep.Schema.parseInputData(_3c4,_3c8,_3c5);
if(_3c9){
HAR.Model.appendData(_3c9);
HAR.Tab.Preview.append(_3c9,_3c8);
var _3ca=HAR.$("sourceEditor");
_3ca.value="";
var _3cb=getElementByClass(_3c6,"tabDOMBody");
_3cb.updated=false;
}
HAR.Viewer.selectTabByName("Preview");
},onDrop:function(_3cc){
cancelEvent(_3cc);
try{
this.handleDrop(_3cc.dataTransfer);
}
catch(err){
HAR.log("har; HAR.Tab.InputView.onDrop EXCEPTION",err);
}
},handleDrop:function(_3cd){
if(!_3cd){
return false;
}
var _3ce=_3cd.files;
...
HAR.log("har; HAR.Tab.InputView.handleDrop "+_3ce.length,_3ce);
for(var i=0;i<_3ce.length;i++){
this.onAppendPreview(_3ce[i].getAsText(""));
}
},onAbout:function(){
...
with(Domplate){
with(HAR.Lib){
HAR.Tab.Preview=HAR.extend({timeline:HAR.Page.Timeline,stats:HAR.Page.Stats,render:function(_b2){
this.timeline.render(getElementByClass(_b2,"pageTimeline"));
this.stats.render(getElementByClass(_b2,"pageStats"));
...
},append:function(_b3,_b4){
var _b5=getElementsByClass(_b4,"errorTable");
for(var i=0;i<_b5.length;i++){
var _b7=_b5[i];
_b7.parentNode.removeChild(_b7);
}
this.buildPageList(_b4,_b3);
this.timeline.append(_b3);
},buildPageList:function(_b8,_b9){
if(!_b9){
return;
}
var _ba=HAR.now();
this.buildPageContent(_b8,null);
var _bb;
var _bc=_b9.log.pages;
if(_bc&&_bc.length){
var _bd=HAR.Rep.PageList;
_bb=_bd.render(_bc,_b8);
if(_bb.firstChild.firstChild&&_bc.length==1){
_bd.toggleRow(_bb.firstChild.firstChild);
}
}
_b8.updated=true;
HAR.log("har; Render preview data: "+formatTime(HAR.now()-_ba));
return _bb;
},buildPageContent:function(_be,_bf){
var _c0=HAR.Model.getPageEntries(_bf);
if(!_c0.length){
return;
}
var _c1=HAR.Rep.EntryList;
this.table=_c1.tableTag.replace({},_be,_c1);
this.summaryRow=_c1.summaryTag.insertRows({},this.table.firstChild)[0];
var _c2=this.table.firstChild;
var _c3=_c2.lastChild.previousSibling;
var row=this.firstRow=_c1.fileTag.insertRows({files:_c0},_c3)[0];
this.phases=[];
phaseMap=[];
var _c5=1000;
var _c6=null;
var _c7=_bf?parseISO8601(_bf.startedDateTime):null;
var _c8=(_bf&&_bf.pageTimings)?_bf.pageTimings.onLoad:0;
for(var i=0;i<_c0.length;i++){
var _ca=_c0[i];
row.repObject=_ca;
row=row.nextSibling;
if(!_c7){
pageSstartedDateTime=parseISO8601(_ca.startedDateTime);
}
var _cb=parseISO8601(_ca.startedDateTime);
var _cc=_c6?parseISO8601(_c6.getLastStartTime()):0;
if(!_c6||((_cb-_cc)>=_c5)&&(_cb>(_c7+_c8))){
_c6=this.startPhase(_ca);
}else{
_c6.addFile(_ca);
}
if(_c6.startTime==undefined||_c6.startTime>_cb){
_c6.startTime=_cb;
}
if(_c6.endTime==undefined||_c6.endTime<_cb+_ca.time){
_c6.endTime=_cb+_ca.time;
}
if(_ca.phase==this.phases[0]&&_c6.endTime<_c7+_c8){
_c6.endTime=_c7+_c8;
}
}
this.updateTimeline(_bf);
this.updateSummaries(_bf);
},startPhase:function(_cd){
var _ce=new HAR.Model.Phase(_cd);
this.phases.push(_ce);
return _ce;
},calculateFileTimes:function(_cf,_d0,_d1){
if(_d1!=_d0.phase){
_d1=_d0.phase;
this.phaseStartTime=_d1.startTime;
this.phaseEndTime=_d1.endTime;
this.phaseElapsed=this.phaseEndTime-_d1.startTime;
}
var _d2=((_d0.timings.dns<0)?0:_d0.timings.dns);
var _d3=_d2+((_d0.timings.connect<0)?0:_d0.timings.connect);
var _d4=_d3+((_d0.timings.blocked<0)?0:_d0.timings.blocked);
var _d5=_d4+((_d0.timings.send<0)?0:_d0.timings.send);
var _d6=_d5+((_d0.timings.wait<0)?0:_d0.timings.wait);
var _d7=_d6+((_d0.timings.receive<0)?0:_d0.timings.receive);
var _d8=_d0.time;
var _d9=parseISO8601(_d0.startedDateTime);
this.barOffset=Math.floor(((_d9-this.phaseStartTime)/this.phaseElapsed)*100);
this.barResolvingWidth=Math.round((_d2/this.phaseElapsed)*100);
this.barConnectingWidth=Math.round((_d3/this.phaseElapsed)*100);
this.barBlockingWidth=Math.round((_d4/this.phaseElapsed)*100);
this.barSendingWidth=Math.round((_d5/this.phaseElapsed)*100);
this.barWaitingWidth=Math.round((_d6/this.phaseElapsed)*100);
this.barReceivingWidth=Math.round((_d7/this.phaseElapsed)*100);
if(_cf){
var _da=parseISO8601(_cf.startedDateTime);
var _db=_cf.pageTimings.onContentLoad;
if(_d0.phase==this.phases[0]&&_db>0){
this.contentLoadBarOffset=Math.floor(((_da+_db-_d1.startTime)/this.phaseElapsed)*100);
}
var _dc=_cf.pageTimings.onLoad;
if(_d0.phase==this.phases[0]&&_dc>0){
this.windowLoadBarOffset=Math.floor(((_da+_dc-_d1.startTime)/this.phaseElapsed)*100);
}
}
return _d1;
},updateTimeline:function(_dd){
var _de=this.table.firstChild;
var _df;
for(var row=this.firstRow;row;row=row.nextSibling){
var _e1=row.repObject;
if(!_e1){
continue;
}
_df=this.calculateFileTimes(_dd,_e1,_df);
row.phase=_e1.phase;
delete _e1.phase;
var _e2=row.childNodes[4].firstChild.childNodes[1];
var _e3=_e2.nextSibling;
var _e4=_e3.nextSibling;
var _e5=_e4.nextSibling;
var _e6=_e5.nextSibling;
var _e7=_e6.nextSibling;
var _e8=_e7.nextSibling;
var _e9=_e8.nextSibling;
_e2.style.left=_e3.style.left=_e4.style.left=_e5.style.left=_e6.style.left=_e9.style.left=this.barOffset+"%";
_e2.style.width=this.barResolvingWidth+"%";
_e3.style.width=this.barConnectingWidth+"%";
_e4.style.width=this.barBlockingWidth+"%";
_e5.style.width=this.barSendingWidth+"%";
_e6.style.width=this.barWaitingWidth+"%";
_e9.style.width=this.barReceivingWidth+"%";
if(this.contentLoadBarOffset){
_e7.style.left=this.contentLoadBarOffset+"%";
_e7.style.display="block";
this.contentLoadBarOffset=null;
}
if(this.windowLoadBarOffset){
_e8.style.left=this.windowLoadBarOffset+"%";
_e8.style.display="block";
this.windowLoadBarOffset=null;
}
}
},updateSummaries:function(_ea){
var _eb=this.phases;
var _ec=0,totalSize=0,cachedSize=0,totalTime=0;
for(var i=0;i<_eb.length;++i){
var _ee=_eb[i];
_ee.invalidPhase=false;
var _ef=this.summarizePhase(_ee);
_ec+=_ef.fileCount;
totalSize+=_ef.totalSize;
cachedSize+=_ef.cachedSize;
totalTime+=_ef.totalTime;
}
var row=this.summaryRow;
if(!row){
return;
}
var _f1=row.firstChild.firstChild;
_f1.firstChild.nodeValue=this.formatRequestCount(_ec);
var _f2=row.childNodes[1].firstChild;
_f2.setAttribute("totalSize",totalSize);
_f2.firstChild.nodeValue=formatSize(totalSize);
var _f3=row.lastChild.firstChild.firstChild;
_f3.setAttribute("collapsed",cachedSize==0);
_f3.childNodes[1].firstChild.nodeValue=formatSize(cachedSize);
var _f4=row.lastChild.firstChild.lastChild.firstChild;
var _f5=formatTime(totalTime);
if(_ea&&_ea.pageTimings.onLoad>0){
_f5+=" (onload: "+formatTime(_ea.pageTimings.onLoad)+")";
}
_f4.innerHTML=_f5;
},formatRequestCount:function(_f6){
return (_f6==1)?$STR("Request"):$STRF("RequestCount",[_f6]);
},summarizePhase:function(_f7){
var _f8=0,totalSize=0;
var _f9="all";
if(_f9=="all"){
_f9=null;
}
var _fa=0;
var _fb=0,maxTime=0;
for(var i=0;i<_f7.files.length;i++){
var _fd=_f7.files[i];
var _fe=parseISO8601(_fd.startedDateTime);
if(!_f9||_fd.category==_f9){
++_fa;
var _ff=_fd.response.content.size;
totalSize+=_ff;
if(_fd.response.status==304){
_f8+=_ff;
}
if(!_fb||_fe<_fb){
_fb=_fe;
}
var _100=_fe+_fd.time;
if(_100>maxTime){
maxTime=_100;
}
}
}
var _101=maxTime-_fb;
return {cachedSize:_f8,totalSize:totalSize,totalTime:_101,fileCount:_fa};
},showInfoTip:function(_102,_103,x,y){
var row=getAncestorByClass(_103,"netRow");
if(row){
if(getAncestorByClass(_103,"netTimeCol")){
_102.setAttribute("multiline",true);
var _107=row.repObject.startedDateTime+"-nettime";
if(_107==this.infoTipURL){
return true;
}
this.infoTipURL=_107;
return this.populateTimeInfoTip(_102,row);
}else{
if(hasClass(_103,"netSizeLabel")){
var _107=row.repObject.startedDateTime+"-netsize";
if(_107==this.infoTipURL){
return true;
}
this.infoTipURL=_107;
return this.populateSizeInfoTip(_102,row);
}
}
return;
}
var _108=getAncestorByClass(_103,"pageStats");
if(_108){
return HAR.Page.Stats.showInfoTip(_102,_103,x,y);
}
},populateTimeInfoTip:function(_109,row){
HAR.Rep.EntryTimeInfoTip.render(row,_109);
return true;
},populateSizeInfoTip:function(_10b,row){
var _10b=HAR.Rep.EntrySizeInfoTip.tag.replace({file:row.repObject},_10b);
return true;
}});
}
}
...
var _2ce=HAR.$("content");
if(!_2ce){
return;
}
this.tabView=this.TabView.render(_2ce);
this.selectTabByName("Input");
var _2cf=getURLParameter("example");
if(!_2cf){
_2cf=getURLParameter("path");
}
if(_2cf){
this.loadLocalArchive(_2cf);
}
var _2d0=getURLParameter("inputUrl");
var _2d1=getURLParameter("callback");
if(_2d0){
this.loadRemoteArchive(_2d0,_2d1);
}
window.onresize=bind(this.onWindowResize,this);
this.onWindowResize();
HAR.Download.create();
fireEvent(_2ce,"onViewerInit");
HAR.log("har; Viewer initialized.",schema);
},onWindowResize:function(){
var _2d2=HAR.$("sourceEditor");
var body=getBody(document);
_2d2.style.width=(body.clientWidth-40)+"px";
},selectTabByName:function(_2d4){
this.TabView.selectTabByName(this.tabView,_2d4);
},loadLocalArchive:function(_2d5,_2d6){
HAR.log("har; loadLocalArchive "+_2d5);
var _2d7=HAR.$("sourceEditor");
if(_2d7){
_2d7.value="Loading...";
}
dojo.xhrGet({url:_2d5,handleAs:"text",load:function(_2d8,_2d9){
if(_2d6){
_2d6(_2d8);
}else{
HAR.Tab.InputView.onAppendPreview(_2d8);
}
},error:function(_2da,_2db){
HAR.error("har; loadLocalArchive ERROR "+_2da);
if(_2d7){
_2d7.value=_2da;
}
}});
},loadRemoteArchive:function(url,_2dd){
HAR.log("har; loadRemoteArchive: "+url+", "+_2dd);
if(!_2dd){
_2dd="onInputData";
}
var _2de=HAR.$("sourceEditor");
_2de.value="Loading...";
var head=document.getElementsByTagName("head")[0];
var _2e0=document.createElement("script");
_2e0.src=url;
window[_2dd]=new Function("HAR.Viewer.onRemoteArchiveLoaded.apply(HAR.Viewer, arguments);"+"if (!dojo.isIE) delete window["+_2dd+"];");
var done=false;
_2e0.onload=_2e0.onreadystatechange=function(){
if(!done&&(!this.readyState||this.readyState=="loaded"||this.readyState=="complete")){
done=true;
head.removeChild(_2e0);
HAR.log("har; Remote archive loaded: "+url);
}
};
head.appendChild(_2e0);
},onRemoteArchiveLoaded:function(data){
HAR.log("har; HAR.Viewer.onRemoteArchiveLoaded");
var _2e3=dojo.toJson(data,true);
HAR.Tab.InputView.onAppendPreview(_2e3);
},loadExample:function(path){
var href=document.location.href;
var _2e6=href.indexOf("?");
document.location=href.substr(0,_2e6)+"?path="+path;
...
var href=document.location.href;
var _2e8=href.indexOf("?");
document.location=href.substr(0,_2e8);
},version:HAR.getVersion(),updateTabBody:function(_2e9,view,_2eb){
var tab=_2e9.selectedTab;
var _2ed=getElementByClass(_2e9,"tabInputBody");
if(hasClass(tab,"InputTab")&&!_2ed.updated){
var _2ee=getElementByClass(_2ed,"inputBody");
_2ed.updated=true;
HAR.Tab.InputView.render(_2ee);
}
var _2ef=getElementByClass(_2e9,"tabPreviewBody");
if(hasClass(tab,"PreviewTab")&&!_2ef.updated){
_2ef.updated=true;
HAR.Tab.Preview.render(_2ef);
}
var _2f0=getElementByClass(_2e9,"tabDOMBody");
if(hasClass(tab,"DOMTab")&&!_2f0.updated){
_2f0.updated=true;
HAR.Tab.DomView.render(HAR.Model.inputData,_2f0);
}
var _2f1=getElementByClass(_2e9,"tabSchemaBody");
if(hasClass(tab,"SchemaTab")&&!_2f1.updated){
_2f1.updated=true;
dojo.xhrGet({url:"schema.js",load:function(_2f2,_2f3){
dojo.require("dojox.highlight");
dojo.require("dojox.highlight.languages.javascript");
var code=dojox.highlight.processString(_2f2).result;
if(dojo.isIE){
code=code.replace(/\n/g,"<br/>");
}
dojo.attr(_2f1.firstChild,{innerHTML:code});
}});
}
var _2f5=getElementByClass(_2e9,"tabHelpBody");
if(hasClass(tab,"HelpTab")&&!_2f5.updated){
_2f5.updated=true;
var _2f6=getElementByClass(_2f5,"helpBody");
var _2f7=HAR.$("HelpTabTemplate");
_2f6.innerHTML=_2f7.innerHTML;
}
},render:function(_2f8){
var _2f9=this.tag.replace({},_2f8,this);
return _2f9;
}});
...
var _1ce=name.lastIndexOf(".");
if(_1ce>0){
name=name.substr(_1ce+1);
}
return name;
}
